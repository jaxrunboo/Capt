...
from app.settings import CAPTCHA_ENTIRE_IMAGE_FILE_PATH, CAPTCHA_SINGLE_IMAGE_FILE_PATH, CHROME_EXE_PATH
...
class Solution(object):
    ...
    def get_all_frames(self) -> List[WebElement]:
        ...
        return self.browser.find_element(By.TAG_NAME, 'iframe')

    def get_captcha_entry_iframe(self) -> WebElement:
        self.browser.switch_to.default_content()
        captcha_entry_iframe = self.browser.find_element(By.CSS_SELECTOR, 'iframe[title="reCAPTCHA"]')
    ...
    def get_captcha_content_iframe(self) -> WebElement:
        self.browser.switch_to.default_content()
        captcha_content_iframe = self.browser.find_element(By.CSS_SELECTOR, 'iframe[src*="bframe?"]')
    ...
    def verify_entire_captcha(self):
        ...
        entire_captcha_element: WebElement = self.get_entire_captcha_element()
        entire_captcha_url = entire_captcha_element.find_element(By.CSS_SELECTOR, 'td img').get_attribute('src')
